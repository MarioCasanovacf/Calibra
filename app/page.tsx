  ...
  return <main className="app-shell">
    ...
    <section className="main-area">
      ...
      {view==="agente" && <div className="page tool-page agent-page">
        <div className="page-title"><div><span className="kicker"><i/> SIN API DE IA</span><h1>Centro Antigravity</h1><p>Gemini hace la investigación dentro de Antigravity; Jossette entrega el contexto, valida el resultado y conserva la memoria.</p></div><span className="agent-mode"><i/> PROTOCOLO V1 ACTIVO</span></div>
